...
<body>
   <div>
   	<p class="p1">
		<p class="p2" style="margin-left:34%; margin-top:-30%; margin-bottom:2.5%;">제목 : <%= name %></p>
		<p class="p2" style="margin-left:34%; margin-top:-2%; margin-bottom:2.5%;">글쓴이  : <%= title %></p>
		<p class="p2" style="margin-left:34%; margin-top:-2%;">작성 시간 : <%= date %></p>
		<p class="p2" style="margin-left:34%; margin-top:-0.3%; height:42%;">내용 : <%= content %></p>
	</p>
	<input type="button" value="글쓰기" class="btn1" style="margin-top:4%;"onclick="location.href='letter.jsp'">
	<input type="button" value="홈으로" class="btn1" onclick="location.href='index.jsp'">
	</div>
</body>
</html>
